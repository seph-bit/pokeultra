...
GiovanniData:
; Rocket Hideout B4F
	db $FF, 32, ONIX, 30, HITMONLEE, 32, GYARADOS, 33, KANGASKHAN, 0
; Silph Co. 11F
	db $FF, 37, HITMONLEE, 39, KANGASKHAN, 37, GYARADOS, 39, PERSIAN, 40, NIDOQUEEN, 0
; Viridian Gym
	db $FF, 50, TAUROS, 49, NIDOQUEEN, 52, PERSIAN, 50, GYARADOS, 52, NIDOKING, 53, RHYDON, 0
...
BrockData:
	db $FF, 11, GEODUDE, 12, ZUBAT, 14, ONIX, 0

MistyData:
	db $FF, 18, PSYDUCK, 20, GOLDEEN, 21, STARMIE, 0

LtSurgeData:
	db $FF, 23, VOLTORB, 24, PORYGON, 26, RAICHU, 0

ErikaData:
	db $FF, 29, WEEPINBELL, 30, EXEGGCUTE, 30, TANGELA, 33, VILEPLUME, 0

KogaData:
	db $FF, 39, BEEDEILL, 40, TENTACRUEL, 39, WEEZING, 42, VENOMOTH, 0

BlaineData:
	db $FF, 48, CHARIZARD, 47, RAPIDASH, 48, ARCANINE, 50, MAGMAR, 0

SabrinaData:
	db $FF, 43, GENGAR, 45, MR_MIME, 43, SLOWBRO, 46, ALAKAZAM, 0
